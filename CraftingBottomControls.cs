...
public sealed partial class InventorySlotsPlugin
{
    private static void LayoutCraftingBottomControls(InventoryGui gui, RectTransform grid)
    {
        ...
        bool updateLayout = _craftingBottomControlsDirty || !string.Equals(_craftingBottomControlsSignature, layoutSignature, StringComparison.Ordinal);
        ...
        _craftingBottomControlsSignature = layoutSignature;
