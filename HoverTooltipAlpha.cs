...
public sealed partial class InventorySlotsPlugin
{
    ...
    private static float GetCraftingHoverTooltipBackgroundAlpha() =>
        Mathf.Clamp01(_craftingHoverTooltipBackgroundAlpha != null ? _craftingHoverTooltipBackgroundAlpha.Value : 0.8f);

    private static float GetInventoryContainerHoverTooltipBackgroundAlpha() =>
        Mathf.Clamp01(_inventoryContainerHoverTooltipBackgroundAlpha != null ? _inventoryContainerHoverTooltipBackgroundAlpha.Value : 1f);
