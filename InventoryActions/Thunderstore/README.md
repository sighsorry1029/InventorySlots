...
Controller support is client-side. With `Enable Controller Hotkeys` enabled, hold `Inventory Action Modifier` (right-stick click / `JoyRStick` by default) while the inventory is open:
